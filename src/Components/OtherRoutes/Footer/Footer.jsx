...
const Footer = () => {
    ...
    return (
        <>
            <div className="footer-container paddingTop100px">
                <div className="footer-content paddingSide">
                    <h3>Munoth Capital</h3>
                    <div className="AdressboxContainer">
                        <div>
                            ...
                            <div className="ContactFormContainer marginTop80px">
                                <div style={{
